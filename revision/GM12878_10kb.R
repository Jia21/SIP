...
k <- fread(paste0(mapsDir, "GM_HiChIP_H3K27ac_b1b2.10k.2.peaks.bedpe"))
...
fwrite(sips, "GM_HiChIP_H3K27ac_b1b2_10kb_10k_2_SIPs.txt", sep="\t", col.names=T)
...
ggplot(score, aes(x=rank, y=intscore)) + 
  ...
  ggtitle("GM12878 H3K27ac HiChIP SIPs (10kb)")+
  theme_bw()
ggsave("./figures/GM_HiChIP_H3K27ac_b1b2_10kb_10k_2_SIPs.png", width=6, height=5)
...
ggsave("./figures/GM_HiChIP_H3K27ac_b1b2_10kb_10k_2_score.png", width=5, height=6)
...
ggplot(data=nPIR, aes(x=SIP, y=log10(N), fill=as.factor(SIP))) + 
  ...
  xlab("Bait Type") + 
  theme_bw()+theme(legend.title = element_blank())
ggsave("./figures/GM_HiChIP_H3K27ac_b1b2_10kb_10k_2_PIR.png", width=5, height=6)
#----------------------------------------------------------------------------------------------#
#----------------------------------------------------------------------------------------------#
